...
-/
@[export leanpy_kernel_env_pickle_m]
...
-/
@[export leanpy_kernel_env_unpickle_m]
...
cause a difference. -/
@[export leanpy_kernel_goal_state_pickle_m]
...
-/
@[export leanpy_kernel_goal_state_unpickle_m]
def goalStateUnpickle (path : System.FilePath) (background? : Option Environment := .none)
  ...
  let ({
    ...
    parentMVars,
    fragments,
  }, region) ← LeanPy.Kernel.unpickle CompactGoalState path
