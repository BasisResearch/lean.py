...
@[export leanpy_kernel_analyze_projection]
...
@[export leanpy_kernel_expr_proj_to_app]
...
@[export leanpy_kernel_unfold_aux_lemmas_m]
def unfoldAuxLemmas (e : Expr) : CoreM Expr := do
  Meta.deltaExpand e isAuxLemma
/-- Unfold all matcher applications -/
@[export leanpy_kernel_unfold_matchers_m]
...
3. No assigned mvars
 -/
@[export leanpy_kernel_instantiate_all_m]
...
@[export leanpy_kernel_to_delayed_mvar_invocation_m]
...
@[export leanpy_kernel_goal_state_diag_m]
...
initialize
  registerTraceClass `LeanPy.Kernel.Delab
